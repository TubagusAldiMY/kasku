...
// Publisher mendefinisikan kontrak minimal yang dibutuhkan dispatcher untuk
// mengirim payload byte ke broker. Diimplementasikan oleh RabbitMQPublisher.
type Publisher interface {
	PublishRaw(ctx context.Context, routingKey string, body []byte) error
}

// Dispatcher membaca outbox_events yang belum dipublish dan mengirimkannya
// ke broker dengan FOR UPDATE SKIP LOCKED untuk safe-concurrent multi-instance.
