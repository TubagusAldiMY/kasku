...
// ValidateTenantSchema memastikan format tenant schema valid sebelum digunakan
// dalam dynamic SQL. Ini adalah pertahanan kritis terhadap SQL injection via
// schema name yang tidak bisa di-parameterisasi di PostgreSQL.
