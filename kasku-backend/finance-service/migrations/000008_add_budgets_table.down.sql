-- Rollback 000008: Drop budgets table from all existing tenant schemas
-- and restore provision_tenant to the 000007 version (without budgets).
...
BEGIN
    ...
    LOOP
        EXECUTE format('DROP TABLE IF EXISTS %I.budgets', r.schema_name);
    END LOOP;
END $$;

-- Restore provision_tenant to 000007 version (without budgets table).
