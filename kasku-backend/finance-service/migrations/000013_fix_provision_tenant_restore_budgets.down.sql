-- Rollback 000013: kembalikan provision_tenant() ke versi 000012 (tanpa budgets).
-- Non-destruktif: tabel budgets yang sudah dibuat TIDAK di-drop agar data tidak hilang.
