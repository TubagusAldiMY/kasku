-- Rollback 000014: Hapus named constraint debts_remaining_amount_non_negative
-- dari semua tenant schema dan kembalikan provision_tenant ke versi 000013
-- (inline unnamed CHECK pada remaining_amount).
...
BEGIN
    ...
    LOOP
        BEGIN
            EXECUTE format(
                'ALTER TABLE %I.debts DROP CONSTRAINT IF EXISTS debts_remaining_amount_non_negative',
                r.schema_name
            );
        EXCEPTION
...
-- Kembalikan provision_tenant ke versi 000013 (remaining_amount pakai inline CHECK
-- tanpa nama constraint eksplisit).
