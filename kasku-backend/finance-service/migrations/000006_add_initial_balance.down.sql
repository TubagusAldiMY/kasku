-- Rollback: remove initial_balance column from all existing tenant schemas
DO $$
DECLARE
    r RECORD;
BEGIN
    ...
    LOOP
        EXECUTE format('ALTER TABLE %I.financial_accounts DROP COLUMN IF EXISTS initial_balance', r.schema_name);
    END LOOP;
END $$;

-- Restore provision_tenant without initial_balance (revert to 000005 version)
