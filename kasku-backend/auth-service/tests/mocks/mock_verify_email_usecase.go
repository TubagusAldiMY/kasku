...
// Source: verify_email_usecase.go
//
// Generated by this command:
//
//	mockgen -source=verify_email_usecase.go -destination=../../tests/mocks/mock_verify_email_usecase.go -package=mocks
//
...
func (m *MockVerifyEmailUseCase) Execute(ctx context.Context, rawToken string) error {
	m.ctrl.T.Helper()
...
func (mr *MockVerifyEmailUseCaseMockRecorder) Execute(ctx, rawToken any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Execute", reflect.TypeOf((*MockVerifyEmailUseCase)(nil).Execute), ctx, rawToken)
}
