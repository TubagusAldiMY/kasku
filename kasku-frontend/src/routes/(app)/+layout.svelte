		...
		<aside class="hidden w-64 flex-col bg-[#0a2e31] p-6 text-white lg:flex">
			...
			<nav class="space-y-0.5">
				{#each [
					...
					{ href: '/accounts', label: 'Rekening', icon: 'M3 10h18M7 10V7a5 5 0 0110 0v3M4 10v10a1 1 0 001 1h14a1 1 0 001-1V10M10 14v4M14 14v4' },
					{ href: '/transactions', label: 'Transaksi', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01m-.01 4h.01' },
					{ href: '/budgets', label: 'Anggaran', icon: 'M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 11h6m-3-8a9 9 0 100 18 9 9 0 000-18z' },
					{ href: '/categories', label: 'Kategori', icon: 'M4 6h16M4 10h16M4 14h16M4 18h16' },
					{ href: '/investments', label: 'Investasi', icon: 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6' },
					{ href: '/debts', label: 'Hutang & Piutang', icon: 'M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z' },
					{ href: '/reports', label: 'Laporan', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z' },
					{ href: '/billing', label: 'Paket', icon: 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4' },
					{ href: '/profile', label: 'Profil', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
				] as item (item.href)}
					<a
						href={item.href}
						class="flex items-center gap-3 rounded-xl px-4 py-2.5 text-sm font-bold transition-colors {isActive(item.href)
				...
				<div class="flex items-stretch overflow-hidden">
					...
					>
						<svg
							...
							viewBox="0 0 24 24"
							stroke="currentColor"
							stroke-width={isActive('/dashboard') ? 2.5 : 1.8}
						>
							<path
								stroke-linecap="round"
								stroke-linejoin="round"
					...
					>
						<svg
							...
							viewBox="0 0 24 24"
							stroke="currentColor"
							stroke-width={isActive('/transactions') ? 2.5 : 1.8}
						>
							<path
								stroke-linecap="round"
								stroke-linejoin="round"
					...
					>
						<svg
							...
							viewBox="0 0 24 24"
							stroke="currentColor"
							stroke-width={isActive('/accounts') ? 2.5 : 1.8}
						>
							<path
								stroke-linecap="round"
								stroke-linejoin="round"
					...
					>
						<svg
							...
							viewBox="0 0 24 24"
							stroke="currentColor"
							stroke-width={isActive('/investments') ? 2.5 : 1.8}
						>
							<path
								stroke-linecap="round"
								stroke-linejoin="round"
					...
					>
						<svg
							...
							viewBox="0 0 24 24"
							stroke="currentColor"
							stroke-width={isActive('/profile') ? 2.5 : 1.8}
						>
							<path
								stroke-linecap="round"
								stroke-linejoin="round"
